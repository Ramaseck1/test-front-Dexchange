...
connexion            </h2>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-10">
                ...
                <h2 className="text-xl text-gray-300 text-bold">Don't have an account? <span><Link href="/routes/register" className="text-teal-400 text-2xl">Sign up </Link></span></h2>
              </form>
            </Form>
          </div>
  );
